        ...
        <div class="flex flex-col w-full max-w-[358px] gap-4 relative mx-auto pt-6 pb-24 px-4">
            ...
            <div class="flex items-center justify-between mb-2">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class="text-black text-[22px] font-semibold">Lahan 12</span>
                </div>
            </div>
            ...
            <div class="flex items-start justify-between mb-2">
                ...
                <div class="flex flex-col">
                    <p class="text-black text-sm font-medium">
                        Luas: <span class="font-normal">7 Ha</span>
                    </p>
                    <p class="text-black text-sm font-medium">
                        Tanaman: <span class="font-normal">Tomat</span>
                    </p>
                </div>
