...
@section('content')
    ...
    <div class="bg-[#F5FFF5] min-h-screen relative">
        ...
        <div class="fixed top-0 left-0 right-0 bg-[#F5FFF5] z-50 px-4 pt-4 pb-4">
            ...
            <!-- Card Filter -->
            <div
                class="relative flex items-center justify-between bg-hijau-paling-muda border border-hijau-tua rounded-2xl px-4 py-3 shadow-sm">
        ...
        <div class="px-4 pb-[150px]">
            <div class="flex flex-col gap-6">
                ...
                <!-- Card 3 -->
                <div
                    class="notification-card flex items-start gap-4 bg-white rounded-3xl border border-white-200 p-4 shadow-sm">
                    <div
                        class="w-14 h-14 flex items-center justify-center bg-white rounded-full border-2 border-gray-300 flex-shrink-0">
                ...
                <div class="notification-card flex items-start gap-4 bg-white rounded-3xl border border-white-200 p-4 shadow-sm"
                    ...
                    <div
                        class="w-14 h-14 flex items-center justify-center bg-white rounded-full border-2 border-gray-300 flex-shrink-0">
                        <img src="{{ asset('asset/img/kelembapantanah.svg') }}" alt="humidity" class="w-[35px] h-[35px]">
                    </div>
                    <div class="flex flex-col flex-1 min-w-0">
                ...
                <div class="notification-card flex items-start gap-4 bg-white rounded-3xl border border-white-200 p-4 shadow-sm"
                    ...
                    <div
                        class="w-14 h-14 flex items-center justify-center bg-white rounded-full border-2 border-gray-300 flex-shrink-0">
                        <img src="{{ asset('asset/img/suhulingkungan.svg') }}" alt="temp" class="w-[35px] h-[35px]">
                    </div>
                    <div class="flex flex-col flex-1 min-w-0">
                ...
                <div id="filterModal" class="hidden fixed inset-0 z-[60]">
                    ...
                    <div id="modalContent"
                        ...
                        <!-- Daftar Lahan -->
                        <div id="lahanList"
                            class="grid grid-cols-1 divide-y divide-gray-200 max-h-[400px] overflow-y-auto">
                            <div data-lahan="1"
                ...
                <div id="deleteModal" class="hidden fixed inset-0 z-[70] flex items-center justify-center">
                    ...
                    <!-- Modal Content -->
                    <div
                        class="relative bg-white rounded-3xl w-[90%] max-w-[320px] p-6 shadow-2xl transform transition-all">
                        <!-- Icon Trash -->
